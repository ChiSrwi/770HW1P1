...
//    lazy var (b, a): ([Double], [Double]) = butterworthLowPass(order: 6, cutoffFrequency: 3.0, samplingRate: 60.0)
    
//    lazy var b: [Double] = {
//        let (bCoeffs, _) = butterworthLowPass(order: 6, cutoffFrequency: 3.0, samplingRate: 60.0)
//        return bCoeffs
//    }()
//    
//    lazy var a: [Double] = {
//        let (_, aCoeffs) = butterworthLowPass(order: 6, cutoffFrequency: 3.0, samplingRate: 60.0)
//        return aCoeffs
//    }()
...
//                     let smoothedMagnitude = movMean(data: filteredMagnitude, windowSize: windowSize)
//                     
//                     let zeroCrossings = zeroCrossingIndices(data: smoothedMagnitude)
//                     let steps = zeroCrossings.count / 2
//                     stepCount = steps
//                     
//                     DispatchQueue.main.async {
//                         self.label.text = "Steps: \(self.stepCount)"
